...
<body>
        ...
        <div class="row">
            <div class="container">
                <div class="header-container text-center">
                    <h2>CRUD CHAUFFEUR</h2>
                    <div class="btnAdd">
                        <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-dark">Ajouter chauffeur</a>
                    </div>
                </div>
                <hr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Mettre à jour le chauffeur</h5>
                ...
                <div class="modal-body">
                    <form id="updateUser">
                        ...
                        <div class="mb-3 row">
                            <label for="nameField" class="col-md-3 form-label">Nom</label>
                            <div class="col-md-9">
    ...
    <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ajouter un chauffeur</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addUser" action="">
                        <div class="mb-3 row">
                            <label for="addUserField" class="col-md-3 form-label">Nom</label>
                            <div class="col-md-9">
