 ...
 */
final class Version20240619232222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piece ADD CONSTRAINT FK_44CA0B23BA62FCC8 FOREIGN KEY (list_piece_id) REFERENCES list_piece (id)');
