...
final class Version20240619181623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inspection (id INT AUTO_INCREMENT NOT NULL, camion_id INT DEFAULT NULL, inspecteur_id INT DEFAULT NULL, date_inspection DATE NOT NULL, resultat TINYINT(1) NOT NULL, commentaire LONGTEXT NOT NULL, INDEX IDX_F9F134853A706D3 (camion_id), INDEX IDX_F9F13485B7728AA0 (inspecteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE videnge (id INT AUTO_INCREMENT NOT NULL, grade_videnge_id INT DEFAULT NULL, km_videnge DOUBLE PRECISION NOT NULL, ecart_type DOUBLE PRECISION NOT NULL, statut TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8483CDC85A68B0 (grade_videnge_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
